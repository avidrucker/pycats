...
def test_air_dodge_zero_velocity_issue():
    ...
    scenarios = [
        ...
        },
        {
            ...
            "air_dodge": InputFrame(
                held={pg.K_q, pg.K_d}, pressed={pg.K_d}, released=set()
            ),
        },
    ]
    ...
    for scenario in scenarios:
        ...
        print(
            f"After setup: pos={player.rect.center}, on_ground={player.on_ground}, state={player.fsm.state}, vel={player.vel}"
        )
        ...
        continue_frame = InputFrame(
            held={pg.K_q, pg.K_d}, pressed=set(), released=set()
        )
