...
for char in test_chars:
    ...
    try:
        rect = text_renderer.render_text_mixed(
            test_text, 16, (255, 255, 255), test_surface, (0, 0)
        )
...
for char in test_chars:
    try:
        rect = text_renderer.render_unicode_char(
            char, 16, (255, 255, 255), test_surface, (0, 0)
        )
...
for char in test_chars:
    ...
    print(
        f"Character '{char}': width={char_surface.get_width()}, is_tofu={is_tofu} {'✗ Wrong!' if is_tofu else '✓ Good'}"
    )
