...
|---|---|---|---|---|---|---|
| Ledge | Ledge-grab intangibility (fixed burst) | FOUND | `LEDGE_INVULN_BASE_FRAMES` | `LEDGE_INVULN_BASE_FRAMES = 21` | [pm-reference/ledge-mechanics.md](./pm-reference/ledge-mechanics.md) → "Validation (#538)" | [rukaidata PM3.6 — CliffCatch](https://rukaidata.com/PM3.6/Mario/subactions/CliffCatch.html) (intangible 1–21, flat across characters; #671) |
