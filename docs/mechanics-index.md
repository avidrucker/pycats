...
| Status-bar / dev-HUD runtime flags | §1.3 | `pycats/storage/runtime_settings.py::show_status_timer_bars`, `pycats/storage/runtime_settings.py::dev_hud` | `docs/research/2026-07-07-custom-mechanics-inventory.md` | invented render toggles |
