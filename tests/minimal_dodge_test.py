...
try:
    ...
    print(f"After settle: state={player.fsm.state}, vel={player.vel}, on_ground={player.on_ground}")
    ...
    print(f"After update: state={player.fsm.state}, vel={player.vel}, timer={player.dodge_timer}")
