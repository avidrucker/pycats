...
def test_caption_hold_frames_takes_the_max_when_captions_coincide():
    caps = [Caption("a", frames=(10, 20), dwell=90), Caption("b", frames=(10, 15), dwell=150)]
...
def test_demo_captions_rejects_dwell_at_outside_the_window():
    demo = Demo(name="d", segments=(DemoSegment("s", spans=(InputSpan(10, 40, 1, "right"),), dwell_at=100),))
