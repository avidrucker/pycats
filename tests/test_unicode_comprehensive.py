...
def test_unicode_system():
    ...
    test_texts = ["Arrows: ►◄↑↓ work?", "Cats: 🐱🐈😸 visible?", "Mixed: Arrow→Cat🐱"]
    ...
    text_renderer.render_text_mixed(
        "Unicode Support Test", 24, (255, 255, 255), screen, (250, 30), center=True
    )
    ...
    for category, chars in test_sets.items():
        text_renderer.render_text_mixed(
            f"{category}:", 16, (200, 200, 200), screen, (20, y)
        )
        y += 25
        ...
        for char in chars:
            ...
            rect = text_renderer.render_unicode_char(
                char, 18, (255, 255, 100), screen, (x, y)
            )
            x += rect.width + 5
            ...
            text_renderer.render_text_mixed(
                f"({fallback})", 12, (150, 150, 150), screen, (x, y + 2)
            )
            x += 30
    ...
    # Instructions
    text_renderer.render_text_mixed(
        "Yellow characters should show Unicode if supported",
        14,
        (200, 200, 200),
        screen,
        (20, y + 20),
    ...
    text_renderer.render_text_mixed(
        "Gray text shows ASCII fallbacks in parentheses",
        14,
        (200, 200, 200),
        screen,
        (20, y + 40),
    ...
    text_renderer.render_text_mixed(
        "Press any key to close", 14, (100, 255, 100), screen, (20, y + 70)
    )
