...
print(
    f"Initial: pos={player.rect.center}, on_ground={player.fighter.on_ground}, vel={player.fighter.vel}"
)
...
print(
    f"After falling: pos={player.rect.center}, on_ground={player.fighter.on_ground}, vel={player.fighter.vel}"
)
...
print(
    f"Ground player settled: pos={player2.rect.center}, on_ground={player2.fighter.on_ground}"
)
...
print(
    f"After ground spot dodge: state={player2.state}, spot_dodge_flag={player2.fighter.spot_dodge_shield_held}"
)
...
for frame in range(1, 4):
    ...
    print(
        f"Ground Frame {frame}: vel={player2.fighter.vel}, gravity_applied={gravity_applied2}"
    )
