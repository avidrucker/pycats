...
print(
    f"Initial: pos={player.rect.center}, on_ground={player.on_ground}, vel={player.vel}"
)
...
print(
    f"After falling: pos={player.rect.center}, on_ground={player.on_ground}, vel={player.vel}"
)
...
print(
    f"Ground player settled: pos={player2.rect.center}, on_ground={player2.on_ground}"
)
...
for frame in range(1, 4):
    ...
    print(
        f"Ground Frame {frame}: vel={player2.vel}, gravity_applied={gravity_applied2}"
    )
