...
def _opp_in_phase(move_frame, cx=130):
    ...
    return _stub(cx, 300, current_move=_move(startup=4, active=3, recovery=20), move_frame=move_frame)
...
def _off_cadence_recovery_attack(whiff_punish_on, frames=200):
    ...
    for f in range(frames):
        ...
        p1_in_recovery = (
            p1.current_move is not None and p1.move_frame > p1.current_move.startup + p1.current_move.active
        )
