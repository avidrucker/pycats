...
try:
    ...
    print(f"Initial: pos={player.rect.center}, on_ground={player.on_ground}, state={player.fsm.state}")
    ...
    for i in range(10):
        ...
        if i == 9:  # Last frame
            print(f"After settling: pos={player.rect.center}, on_ground={player.on_ground}, state={player.fsm.state}")
    ...
    print(f"After dodge trigger: vel={player.vel}, state={player.fsm.state}, timer={player.dodge_timer}")
