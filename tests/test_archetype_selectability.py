...
def test_char_select_roster_is_the_implemented_archetypes():
    ...
    assert list(cs.characters) == ["nalio", "birky"]
...
def test_create_from_selection_threads_the_chosen_fighter_data():
    ...
    assert bs.player1.fighter_data is load_fighter_data("nalio")
    assert bs.player2.fighter_data is load_fighter_data("birky")
